...
public interface Triggerable extends Collidable {
	 ...
	 * 
	 * @return True if this object does fire events instead of colliding. False otherwise.
	 */
	public boolean isTrigger();

	/**
	 * Changes the trigger value. If true, this object will fire events instead of colliding.
	 * 
	 * @param trigger True if this object does fire events instead of colliding. False otherwise.
	 */
